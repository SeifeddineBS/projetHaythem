    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800" style="text-align:center">Modifier Livraisons</h1>
                  ...
                  <div>
                    ...
                    <div class="modal-body mx-3"><?PHP
                                                  ...
                                                  if (isset($_GET['id'])) {
                                                    ...
                                                    $result = $livraisonController->recupererLivraison($_GET['id']);
                          ...
                          <form method="POST" action="modifierLivraison.php?id=<?PHP echo $row['id']; ?> ">
                            ...
                            <div class="form-group">
                              ...
                              <input value="<?PHP echo $telephone ?>" class="form-control" name="telephone" placeholder=" Telephone" rows="10" type="number"></textarea>
                            </div>
                            <div class="form-group">
                              <label>Adresse</label>
                            ...
                            <div class="form-group">
                              ...
                              <input value="<?PHP echo $commande ?>" class="form-control" name="commande" placeholder=" Commande" rows="10" type="number"></textarea>
                            </div>
                            ...
                            <button type="submit" name="modifier" value="modifier" class="ajouter">modifier</button>
                                                  ...
                                                  if (isset($_POST['modifier'])) {
                                                    $livraison = new Livraison($_POST['nom'], $_POST['email'], $_POST['telephone'], $_POST['adresse'], $_POST['commande']);
                                                    $livraisonController->modifierLivraison($livraison, $_GET['id']);
                                                    echo $_POST['id'];
